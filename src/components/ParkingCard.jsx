...
function ParkingCard({ ParkingInfo }) {
  ...
  return (    
      <div
            className="relative p-6 bg-amber-[80] rounded-2xl shadow-2xl transform hover:scale-105 duration-300 ease-in-out "
          >
            {ParkingInfo.isNew && (
            ...
            <p className="text-gray-600 text-sm mb-2">
              💰 {ParkingInfo.pricePerHour} Ar/heure
            </p>

            <p className="text-gray-600 text-sm mb-6">
              🕒 Ouvert 24h/24 &nbsp;|&nbsp; 🔒 Sécurisé
            </p>
