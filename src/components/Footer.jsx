        ...
        <>
            <footer className="bg-gray-900 text-white pt-16 pb-8">
                ...
                <div>
                    ...
                    <div className="flex">
                        <input type="email" placeholder="Your email address" className="px-4 py-2 bg-gray-800 text-white border-none !rounded-l-button w-full focus:bg-gray-700"/>
            ...
            <div className="pt-8 border-t border-gray-800 text-center text-gray-400">
                ...
                <p>© 2025 Parking Zone. All rights reserved. | <a href="#" className="hover:text-white">Privacy Policy</a> | <a href="#" className="hover:text-white">Terms of Service</a></p>
            </div>
        </div>
    </footer>
        </>
