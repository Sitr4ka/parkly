        ...
        <>
            <footer class="bg-gray-900 text-white pt-16 pb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        ...
                        <div>
                            <h3 className="text-2xl font-['Pacifico'] mb-6">Parking Zone</h3>
                                <p className="text-gray-400 mb-6">Revolutionizing urban parking with smart, convenient solutions for drivers and property owners.</p>
                    ...
                    <div>
                        <h4 className="text-lg font-semibold mb-6">Quick Links</h4>
                            <ul className="space-y-3">
                                ...
                                <li><a href="#" className="text-gray-400 hover:text-white transition-all duration-300">Locations</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-white transition-all duration-300">Blog</a></li>
                            </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li class="flex items-center">
                                ...
                                <span class="text-gray-400">info@parkingzone.com</span>
                            </li>
                            <li class="flex items-center">
                ...
                <div>
                    ...
                    <div className="flex">
                        <input type="email" placeholder="Your email address" class="px-4 py-2 bg-gray-800 text-white border-none !rounded-l-button w-full focus:bg-gray-700"/>
                        <button className="bg-primary px-4 py-2 !rounded-r-button hover:bg-primary/90 transition-all duration-300 whitespace-nowrap">Subscribe</button>
                    </div>
                </div>
            </div>
            ...
            <div className="pt-8 border-t border-gray-800 text-center text-gray-400">
                ...
                <p>© 2025 Parking Zone. All rights reserved. | <a href="#" class="hover:text-white">Privacy Policy</a> | <a href="#" class="hover:text-white">Terms of Service</a></p>
            </div>
        </div>
    </footer>
        </>
