          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 md:pl-12">
              ...
              <p className="text-lg text-gray-600 mb-8">
                We're revolutionizing the way people find and book parking spaces with
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Our users save an average of 15 minutes per parking session by booking in
                      advance.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Enjoy competitive rates and exclusive discounts for regular users and
                      long-term bookings.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      With a 4.8/5 rating from over 50,000 users, our service quality speaks for
                      itself.
                    </p>
                  </div>
                </div>
